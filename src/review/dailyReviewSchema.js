...
export const reviewSections = [
  { title: "学习", groups: [
    { title: "数学", fields: [duration("study.math.totalMinutes", "总时长", { parts: ["study.math.calculus.duration", "study.math.linearAlgebra.duration"] }), duration("study.math.calculus.duration", "高等数学"), duration("study.math.linearAlgebra.duration", "线性代数"), text("study.math.progress", "数学今日推进"), text("study.math.calculus.progress", "高等数学推进"), text("study.math.linearAlgebra.progress", "线性代数推进"), text("study.math.adjustment", "调整")] },
