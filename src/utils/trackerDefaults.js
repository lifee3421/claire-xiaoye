...
export const DEFAULT_TRACKERS = [
  { id: "family-a", title: "联系外婆", emoji: "📞", enabled: true, schedule: { kind: "interval", every: 7, unit: "day" }, goal: { aggregation: "occurrence", target: 1, unit: "times" }, evidenceBindings: [{ type: "categoryId", categoryId: "family.contact.grandmother" }, { type: "legacyMaintenanceId", maintenanceId: "family-a" }], stickerSettings: stickerSettings("联系外婆", "📞") },
  ...
  { id: "exercise-complete", title: "完整运动", emoji: "🏃", enabled: true, schedule: { kind: "period", period: "week" }, goal: { aggregation: "active_days", target: 4, unit: "days" }, evidenceBindings: [{ type: "reviewFieldPath", path: ["fields", "exercise.today.totalMinutes"], valueType: "duration" }, { type: "reviewFieldPath", path: ["exerciseMinutes"], valueType: "duration" }, { type: "legacyMaintenanceId", maintenanceId: "exercise-complete" }], stickerSettings: stickerSettings("完整运动", "🏃") },
