...
test("TrackerManager model: editing only the default family-a title persists the complete effective snapshot", () => {
  ...
  assert.deepEqual(payload.evidenceBindings, [{ type: "categoryId", categoryId: "family.contact.grandmother" }, { type: "legacyMaintenanceId", maintenanceId: "family-a" }]);
...
test("TrackerManager model: changing only emoji or schedule retains family-a evidence, goal, and sticker settings", () => {
  ...
  assert.deepEqual(emoji.evidenceBindings, [{ type: "categoryId", categoryId: "family.contact.grandmother" }, { type: "legacyMaintenanceId", maintenanceId: "family-a" }]);
  ...
  assert.deepEqual(schedule.evidenceBindings, [{ type: "categoryId", categoryId: "family.contact.grandmother" }, { type: "legacyMaintenanceId", maintenanceId: "family-a" }]);
...
test("TrackerManager model: disabling a default tracker survives reload and does not alter its history configuration", () => {
  ...
  assert.deepEqual(effective.evidenceBindings, [{ type: "categoryId", categoryId: "family.contact.grandmother" }, { type: "legacyMaintenanceId", maintenanceId: "family-a" }]);
  assert.deepEqual(effective, payload);
});
